...
| 入口 | 窗口 | 说明 |
|---|---|---|
| 侧边栏 → 🕒 | 时间枢纽 | 横向药丸状无边框时间条 + 独立面板双窗口架构；展开时根据屏幕空间优先向上/向下贴边弹出，避免 Windows 透明窗口 resize 闪烁 |
| 任务页头部 |时间枢纽 | 同上 |
| 笔记详情工具栏 | 悬挂笔记 | 当前笔记的只读 Markdown 窗口，始终置顶 |
| 系统托盘右键 | 悬挂时间枢纽 | 随时从托盘呼出，无需打开主窗口 |
...
*Created by Code Agent Ω — 2026.03.18 | Last updated: 2026.04.02 v2.9.1 时间枢纽稳定性修复 — 双窗口展开、首开预热与边缘方向适配*
